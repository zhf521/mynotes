import{_ as n,o as s,c as a,b as t}from"./app-1a001120.js";const p={},e=t(`<p>Pinia 是 Vue 的存储库，它允许您跨组件/页面共享状态，类似vuex</p><h2 id="_1-安装pinia" tabindex="-1"><a class="header-anchor" href="#_1-安装pinia" aria-hidden="true">#</a> 1. 安装Pinia</h2><p>在项目中安装：</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token function">yarn</span> <span class="token function">add</span> pinia
