import{_ as n,o as s,c as a,b as t}from"./app-59ed2b97.js";const p={},e=t(`<h2 id="_1-认识栈结构" tabindex="-1"><a class="header-anchor" href="#_1-认识栈结构" aria-hidden="true">#</a> 1. 认识栈结构</h2><p>栈（stack）又名堆栈，它是一种运算受限的线性表。限定仅在表尾进行插入和删除操作的线性表。这一端被称为栈顶，相对地，把另一端称为栈底。向一个栈插入新元素又称作进栈、入栈或压栈，它是把新元素放到栈顶元素的上面，使之成为新的栈顶元素；从一个栈删除元素又称作出栈或退栈，它是把栈顶元素删除掉，使其相邻的元素成为新的栈顶元素</p><p>特点：后进先出即Last in First Out（LIFO）</p><h2 id="_2-用数组表示" tabindex="-1"><a class="header-anchor" href="#_2-用数组表示" aria-hidden="true">#</a> 2. 用数组表示</h2><p>只使用<code>pop</code>和<code>push</code>完成增删的数组</p><h2 id="_3-封装栈结构" tabindex="-1"><a class="header-anchor" href="#_3-封装栈结构" aria-hidden="true">#</a> 3. 封装栈结构</h2><div class="language-javascript line-numbers-mode" data-ext="js"><pre class="language-javascript"><code><span class="token comment">//push 添加一个元素到栈顶</span>
