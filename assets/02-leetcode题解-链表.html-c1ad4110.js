import{_ as p,r as o,o as c,c as l,d as n,e as s,a as e,b as t}from"./app-89b39a64.js";const i={},d=n("h2",{id:"_1-【2】两数相加",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#_1-【2】两数相加","aria-hidden":"true"},"#"),s(" 1. 【2】两数相加")],-1),u=n("h3",{id:"_1-题目描述",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#_1-题目描述","aria-hidden":"true"},"#"),s(" 1. 题目描述")],-1),r={href:"https://leetcode.cn/problems/add-two-numbers/",target:"_blank",rel:"noopener noreferrer"},k=t(`<p>给你两个 <strong>非空</strong> 的链表，表示两个非负的整数。它们每位数字都是按照 <strong>逆序</strong> 的方式存储的，并且每个节点只能存储 <strong>一位</strong> 数字</p><p>请你将两个数相加，并以相同形式返回一个表示和的链表</p><p>你可以假设除了数字 0 之外，这两个数都不会以 0 开头</p><p><strong>示例 1：</strong></p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>输入：l1 = [2,4,3], l2 = [5,6,4]
输出：[7,0,8]
解释：342 + 465 = 807.
