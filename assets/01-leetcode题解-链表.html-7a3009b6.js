import{_ as p,r as o,o as l,c as i,d as n,e as s,a as e,b as t}from"./app-ac3006bf.js";const c={},d=n("h2",{id:"_1-【2】两数相加",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#_1-【2】两数相加","aria-hidden":"true"},"#"),s(" 1. 【2】两数相加")],-1),r=n("h3",{id:"_1-题目描述",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#_1-题目描述","aria-hidden":"true"},"#"),s(" 1. 题目描述")],-1),u={href:"https://leetcode.cn/problems/add-two-numbers/",target:"_blank",rel:"noopener noreferrer"},k=t(`<p>给你两个 <strong>非空</strong> 的链表，表示两个非负的整数。它们每位数字都是按照 <strong>逆序</strong> 的方式存储的，并且每个节点只能存储 <strong>一位</strong> 数字</p><p>请你将两个数相加，并以相同形式返回一个表示和的链表</p><p>你可以假设除了数字 0 之外，这两个数都不会以 0 开头</p><p><strong>示例 1：</strong></p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>输入：l1 = [2,4,3], l2 = [5,6,4]
输出：[7,0,8]
解释：342 + 465 = 807.
...
<span class="token punctuation">}</span><span class="token punctuation">;</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_8-【】" tabindex="-1"><a class="header-anchor" href="#_8-【】" aria-hidden="true">#</a> 8. 【】</h2><h3 id="_1-题目描述-7" tabindex="-1"><a class="header-anchor" href="#_1-题目描述-7" aria-hidden="true">#</a> 1. 题目描述</h3><p>来源：</p><h3 id="_2-解题思路-7" tabindex="-1"><a class="header-anchor" href="#_2-解题思路-7" aria-hidden="true">#</a> 2. 解题思路</h3><h3 id="_3-题解-7" tabindex="-1"><a class="header-anchor" href="#_3-题解-7" aria-hidden="true">#</a> 3. 题解</h3><div class="language-javascript line-numbers-mode" data-ext="js"><pre class="language-javascript"><code></code></pre><div class="line-numbers" aria-hidden="true"></div></div>`,21);function j(H,D){const a=o("ExternalLinkIcon");return l(),i("div",null,[d,r,n("p",null,[s("来源："),n("a",u,[s("https://leetcode.cn/problems/add-two-numbers/"),e(a)])]),k,n("p",null,[s("来源："),n("a",v,[s("https://leetcode.cn/problems/remove-nth-node-from-end-of-list/"),e(a)])]),m,n("p",null,[s("来源："),n("a",b,[s("https://leetcode.cn/problems/swap-nodes-in-pairs/"),e(a)])]),h,n("p",null,[s("来源："),n("a",x,[s("https://leetcode.cn/problems/reverse-linked-list-ii/"),e(a)])]),g,n("p",null,[s("来源："),n("a",f,[s("https://leetcode.cn/problems/linked-list-cycle-ii/"),e(a)])]),w,n("p",null,[s("来源："),n("a",y,[s("https://leetcode.cn/problems/remove-linked-list-elements/"),e(a)])]),_,n("p",null,[s("来源："),n("a",N,[s("https://leetcode.cn/problems/reverse-linked-list/"),e(a)])]),L])}const E=p(c,[["render",j],["__file","01-leetcode题解-链表.html.vue"]]);export{E as default};
